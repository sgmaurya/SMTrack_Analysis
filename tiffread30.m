function stack = tiffread30(filename, indices, varargin)

% tiffread, version 3.00 Dec 20, 2011
%
% stack = tiffread;
...
switch( TIF.SampleFormat(plane_nb) )
    case 1
    ...
    otherwise
        error('unsuported TIFF sample format %i', TIF.SampleFormat(plane_nb));
end
